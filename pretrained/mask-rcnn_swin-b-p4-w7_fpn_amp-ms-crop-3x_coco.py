...
epochs = 200
launcher = 'pytorch'
load_from = 'pretrained/mask-rcnn_swin-b-p4-w7_fpn_amp-ms-crop-3x_coco/epoch_15.pth'
log_level = 'INFO'
...
val_evaluator = dict(
    ann_file=
    '/home/work/ssy_data/lululab/scalp/230904-data_balance_v2/annotations/coco_val_trim.json',
    backend_args=None,
    format_only=False,
    metric=[
        'bbox',
...
work_dir = './work_dirs/mask-rcnn_swin-b-p4-w7_fpn_amp-ms-crop-3x_coco'
